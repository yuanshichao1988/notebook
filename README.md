...
8.说一下学习`JVM`后对自己写代码上有什么提高和帮助。

9.说一个你认为你因为钻研技术而成功解决的棘手问题。

10.你期望的`Team`和`Platform`是什么样的。
...
30.独立引入`ribbitmq`和`redis`你踩过的坑。

31.`nginx`和`ribbon`的区别

32.说一下`SpringCloud`组件有哪些。
